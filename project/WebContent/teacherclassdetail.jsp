                  ...
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      ...
                      <ul class="post-info">
                        ...
                        <ul class="post-info">
                        <span> Class Code:<%=rs.getString(5) %></span>
                      </ul>
                    </div>
                  </div>
                </div>
                      ...
                      <form id="comment" action="studentpostAction.jsp" method="post">
                        <div class="row">
                          <div class="col-lg-12">
                            ...
                            <input type="hidden" name="post_writer" value=<%= session.getAttribute( "teacher_mail" )%>>
                ...
                <div class="col-lg-12">
                  <div class="blog-post">
                    ...
                    while(rs.next()){
                    	 ...
                    	 ResultSet rsmm= teacherbilgi.findteachername(student_mail2);
                    	 while(rsmm.next()){
                    			 
                    	%>
                    	
                    <div class="down-content">
                      <span><%=rsmm.getString(1) %></span><%} %>
                      <input type= "hidden" name="comment_classid" value="<%=class_id2%>">
                      <input type= "hidden" name="class_id" value="<%=class_id2%>">
                        ...
                        <div class="row">
                          <div class="col-6">
                            ...
                            {%>
                            	  ...
                            	  <li><a href="deletepost.jsp?post_id=<%=rs.getInt(1) %>&class_id=<%=class_id2%>&page_number=<%=1%>">Delete</a></li>
                          ...
                          <div class="col-md-12 col-sm-12">
                            <fieldset>
                              ...
                              <input type= "hidden" name="page_number" value=<%=1 %>>
                               <input type= "hidden" name="comment_classid" value="<%=class_id2%>">
                     			 <input type= "hidden" name="comment_postid" value="<%=rs.getInt(1)%>">
                     			 <input type= "hidden" name="student_mail" value="<%=session.getAttribute( "teacher_mail" )%>">
                            </fieldset>
                          </div>
