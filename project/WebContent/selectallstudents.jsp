          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title"></h5>
                     <div class="content">
                      <h5><a class="submit" href="addnewstudent.jsp">Add New Student</a></h5>
       <div class="col-md-12">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table tablesorter " id="">
                    ...
                    {
                    if (query!= null){
                    	 rs= st.executeQuery("select * from student where student_name like '%"+query+"%'");
                    }
                    else
                    {
					...
					<%=rs.getString(5) %>
                          ...
                          <td>
                    <a href='studentdelete.jsp?student_id=<%=student_id%>'>DELETE</a>
					
                        </td>
                          <td>
					  <a href='studentupdate.jsp?student_id=<%=student_id%>'>UPDATE</a>
                        </td>
                      </tr>
                      <%
                    }
                  ...
                  <a href='exportstudentdata.jsp'>Export Data</a>
              </div>
            </div>
          </div>
              </div>
