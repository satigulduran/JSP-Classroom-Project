          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Update Your Information</h5>
              </div>

              <div class="card-body">
                <form action ="./updateadminAction.jsp"  method = "post">
 				<jsp:useBean id="cbilgi" class="adminoperation.admindatabaseislemleri"></jsp:useBean>
                    <%
                    String admin_mail= session.getAttribute( "admin_mail" ).toString() ;
                    
                    
                    try{
                    	
                    	ResultSet rs = cbilgi.selectAllDataadmin(admin_mail);
                  ...
                  <div class="row">
                    <div class="col-md-5 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="admin_id"  placeholder="Class ID" value="<%=rs.getString(1)%>" required readonly>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="admin_name" placeholder="Admin Name"  value="<%=rs.getString(2)%>" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="admin_mail" placeholder="Admin Mail" value="<%=rs.getString(3)%>"  required readonly>
                      </div>
                    </div>
                   <div class="col-md-4 pr-md-1">
                  ...
                  <div class="row">
                    <div class="col-md-8">
                       <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="admin_sifre" placeholder="Admin Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" value="<%=rs.getString(4)%>"  required>
                      </div>
                    </div>
                  </div>
