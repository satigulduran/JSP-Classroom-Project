          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="text-content">
                <h4>You're currently signed in as <%= session.getAttribute( "student_mail" ) %></h4>
                  <%
              ...
              <div class="row">
                <div class="col-lg-8">
                  <div class="sidebar-item contact-form">
                    ...
                    <div class="content">
                      <form id="contact" action="updatestudentAction.jsp"  method="post">
                        ...
                        <div class="row">
                         <div class="col-md-6 col-sm-12">
                          ...
                          <div class="col-md-6 col-sm-12">
                            ...
                            <fieldset>
                             <input type="email" class="form-control"  name="student_mail"placeholder="Email address" value="<%=rs.getString(3)%>"  required readonly>
                            </fieldset>
                          </div>
                            <div class="col-md-6 col-sm-12">
                           
                            <fieldset>
										<input type="password" class="form-control" name="student_password" placeholder="Password" value="<%=rs.getString(4)%>" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                            </fieldset>
                          </div>
