                ...
                <form action ="./updateadminAction.jsp"  method = "post">
 				<jsp:useBean id="cbilgi" class="adminoperation.admindatabaseislemleri"></jsp:useBean>
                    ...
                    try{
                    	...
                    	ResultSet rs = cbilgi.selectAllData(admin_id);
                  ...
                  <div class="row">
                    <div class="col-md-4 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="admin_mail" placeholder="Admin Mail" value="<%=rs.getString(3)%>"  required>
                      </div>
                    </div>
                   <div class="col-md-4 pr-md-1">
                  ...
                  <div class="row">
                    <div class="col-md-8">
                       <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="admin_sifre" placeholder="Admin Password" value="<%=rs.getString(4)%>" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                      </div>
                    </div>
                  </div>
