          ...
          <div class="row justify-content-center">
            ...
            <form action="teacherloginAction.jsp" method="post">
              ...
              <div class="form-group last mb-4">
                ...
                <input type="password" name="teacher_password"class="form-control"  required>
              ...
              <div class="d-flex mb-5 align-items-center">
                ...
                <span class="ml-auto"><a href="teacherforgotpassword.jsp" class="forgot-pass">Forgot Password</a></span> 
              </div>
                  
              <input type="submit" value="Login" class="btn btn-block btn-primary">
				 <div class="control__indicator"></div>
				              
				                 <span class="ml-auto"><a href="teachersignup.jsp" class="forgot-pass">Sign up</a></span> 
				              </div>
