          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title"></h5>
                     <div class="content">
                      <h5><a class="submit" href="addnewclass.jsp">Add New Class</a></h5>
                                            <div class="col-md-12">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table tablesorter " id="">
                    ...
                    {
                    if (query!= null){
                    	 rs= st.executeQuery("select * from class where class_name like '%"+query+"%'");
                    }
                    else
                    {
					...
					<%=rs.getString(5) %>
                          ...
                          <td>
                    <a href='classdelete.jsp?class_id=<%=class_id%>'>DELETE</a>
					
                        </td>
                          <td>
					  <a href='classupdate.jsp?class_id=<%=class_id%>'>UPDATE</a>
                        </td>
                      </tr>
                      <%
                    }
                  ...
                  <a href='exportclassdata.jsp'>Export Data</a>
              </div>
            </div>
          </div>
              </div>
