                ...
                <form action ="./updateteacherAction.jsp"  method = "post">
 				<jsp:useBean id="sbilgi" class="teacheroperation.teacherdatabaseislemleri"></jsp:useBean>
                    ...
                    try{
                    	...
                    	ResultSet rs = sbilgi.selectAllData(teacher_id);
                 ...
                 <div class="row">
                    <div class="col-md-5 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"   name="teacher_id"  placeholder="Company" value="<%=rs.getString(1)%>" readonly>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="teacher_name" placeholder="Teacher Name"     value="<%=rs.getString(2)%>"required>
                            <input type="hidden" name="teacher_page" value=<%=0 %>>
                      </div>
                    </div>
                  </div>
                    <div class="row">
                    <div class="col-md-8">
                       <div class="form-group">
                        ...
                        <input type="email" class="form-control"  name="teacher_mail" placeholder="Student Mail" value="<%=rs.getString(3)%>" required>
                      </div>
                   <div class="col-md-4 pr-md-1">
                    ...
                    <div class="col-md-8">
                      <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="teacher_password" placeholder="Teacher Password" value="<%=rs.getString(4)%>" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                      </div>
                    </div>
                  </div>
