...
int ne = randx.nextInt(90000) + 10000;
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Create Class</h5>
              </div>

              <div class="card-body">
                <form action ="./addnewclassAction.jsp"  method = "post">

                  <div class="row">
                    <div class="col-md-5 pr-md-1">
                      <div class="form-group">
                        <label>Class ID</label>
                        <input type="text" class="form-control"   name="class_id"  placeholder="Company" value="<%=ne%>" readonly>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-4 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="class_code" placeholder="Class Code" value=<%=code %> required readonly>
                      </div>
                    </div>
                   <div class="col-md-4 pr-md-1">
                  ...
                  <div class="row">
                    <div class="col-md-8">
                       <div class="form-group">
						...
						<select name="country"> 
						<%
					ResultSet rs=	tbilgi.findteachername();
						while(rs.next())
