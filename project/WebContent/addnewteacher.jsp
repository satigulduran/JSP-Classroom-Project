          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Create Teacher</h5>
              </div>
                  ...
                  <div class="row">
                    <div class="col-md-5 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"   name="teacher_id"  placeholder="Company" value="<%=n%>" readonly>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                       <div class="form-group">
                        ...
                        <input type="email" class="form-control"  name="teacher_mail" placeholder="Teacher Mail"  required>
                   ...
                   <div class="col-md-4 pr-md-1">
                    ...
                    <div class="col-md-8">
                      <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="teacher_password" placeholder="Teacher Password"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                      </div>
                    </div>
                  </div>
