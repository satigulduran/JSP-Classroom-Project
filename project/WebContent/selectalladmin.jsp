            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="dropdown nav-item">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                  ...
                  <li class="nav-link"><a href="firstpage.jsp" class="nav-item dropdown-item">Log out</a></li>
                </ul>
              </li>
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title"></h5>
                     <div class="content">
                      <h5><a class="submit" href="addnewadmin.jsp">Add New Admin</a></h5>
                      <div class="col-md-12">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table tablesorter " id="">
                    ...
                    {
                    if (query!= null){
                    	 rs= st.executeQuery("select * from admin where admin_name like '%"+query+"%'");
                    }
                    else
                    {
						
                    	 rs = cbilgi.selectAllData();
                    }
                    while (rs.next())
                    {
					...
					<%=rs.getString(4) %>
                          ...
                          <td>
                    <a href='admindelete.jsp?admin_id=<%=admin_id%>'>DELETE</a>
					
                        </td>
                          <td>
					  <a href='adminupdate.jsp?admin_id=<%=admin_id%>'>UPDATE</a>
                        </td>
                      </tr>
                      <%
                    }
                  ...
                  <a href='exportadmindata.jsp'>Export Data</a>
              </div>
            </div>
          </div>
              </div>
