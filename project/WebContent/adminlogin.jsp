        ...
        <div class="col-md-6 contents">
          <div class="row justify-content-center">
            ...
            <form action="adminloginAction.jsp" method="post">
                ...
                <input type="email" name=admin_mail class="form-control"   required>
              ...
              <div class="d-flex mb-5 align-items-center">
                ...
                <span class="ml-auto"><a href="adminforgotpassword.jsp" class="forgot-pass">Forgot Password</a></span> 
              </div>
