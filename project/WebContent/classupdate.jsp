        ...
        <div class="row">
          <div class="col-md-8">
            <div class="card">
              ...
              <h2><a class="back" href="selectallclass.jsp"><i class='fas fa-arrow-circle-left'>BACK</i></a></h2>
                <h5 class="title">Update Class</h5>
              </div>

              <div class="card-body">
                <form action ="./updateclassAction.jsp"  method = "post">
 				<jsp:useBean id="cbilgi" class="classoperation.classdatabaseislemleri"></jsp:useBean>
 				 <jsp:useBean id="tbilgi" class="teacheroperation.teacherdatabaseislemleri"></jsp:useBean>
                    ...
                    try{
                    	...
                    	ResultSet rs = cbilgi.selectAllData(class_id);
                  ...
                  <div class="row">
                    <div class="col-md-5 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="class_id"  placeholder="Class ID" value="<%=rs.getString(1)%>" required>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="class_name" placeholder="Class Name"  value="<%=rs.getString(2)%>" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="class_code" placeholder="Class Code" value="<%=rs.getString(5)%>"  required readonly>
                      </div>
                    </div>
                   <div class="col-md-4 pr-md-1">
                    </div>
                       ...
                       <div class="form-group">
                        <label>Class Teacher </label>
                         ...
                         <li class="dropdown nav-item">
               			   ...
               			   <b class="caret d-none d-lg-block d-xl-block"></b>  </a>
										          
						<select name="country"> 
						
						<option value="<%=rs.getString(3)%>"><%=rs.getString(3) %></option> <%
					ResultSet rs3=	tbilgi.findteachername();
						while(rs3.next())
						{ String deger= rs3.getString(1);
						%>
                 ...
                 <div class="row">
                    <div class="col-md-8">
                       <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="class_subject" placeholder="Class Teacher" value="<%=rs.getString(4)%>"  required>
                      </div>
                    </div>
                  </div>
              </div>
